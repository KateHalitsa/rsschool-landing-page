...
<section id="center">
  <div class="hero">
    ...
    <img src="${javascript_default}" class="framework" alt="JavaScript logo"/>
    ...
    <ul>
      ...
      <li>
        <a href="https://developer.mozilla.org/en-US/docs/Web/JavaScript" target="_blank">
          <img class="button-icon" src="${javascript_default}" alt="">
          Learn more
        </a>
      </li>
    </ul>
...
//# sourceMappingURL=index-CpZakZjb.js.map